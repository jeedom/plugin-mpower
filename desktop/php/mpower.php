...
<div class="row row-overflow">
  ...
  <div class="cursor" id="bt_healthmpower" style="background-color : #ffffff; height : 120px;margin-bottom : 10px;padding : 5px;border-radius: 2px;width : 160px;margin-left : 10px;" >
    <center>
...
<legend><i class="icon techno-cable1"></i>  {{Mes Mpowers}}
        </legend>
        <div class="eqLogicThumbnailContainer">
          <?php
                foreach ($eqLogics as $eqLogic) {
                    ...
                    if ($eqLogic->getConfiguration('model', '') != '') {
                        echo '<img src="plugins/mpower/doc/images/' . $eqLogic->getConfiguration('model', '') . '.jpg" height="105" width="105" />';
                    } else {
                        echo '<img src="plugins/mpower/doc/images/mpower_icon.png" height="105" width="105" />';
                    }
                    echo "</center>";
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <select id="sel_object" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="model">
                            <option value="6power">{{6 prises}}</option>
                            <option value="3power">{{3 prises}}</option>
                            <option value="1power">{{1 prise}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
